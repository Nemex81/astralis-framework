...
Write-Host " ASTRALIS BOOTSTRAP PROGETTO (Protocollo Onboarding) — Luca & Antigravity" -ForegroundColor Cyan
...
# 4. Copia Template GEMINI.md se non esiste
...
# 5. Copia Template README.md se non esiste
...
# 6. Copia Template CHANGELOG.md se non esiste
